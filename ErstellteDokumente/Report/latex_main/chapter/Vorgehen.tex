...
Das Projekt knüpft an zwei Arbeiten an. Zum einen an dem Projektseminar \cite{PJS_Denys}, in dem der Grundstein in Python gelegt wurde und zum anderen an einer funktionierenden Implementierung des nichtlinearen Bestandteils des Modells aus \figref{fig:Hammerstein} in MATLAB nach \cite{harzheim}.
\subsection{Python}
