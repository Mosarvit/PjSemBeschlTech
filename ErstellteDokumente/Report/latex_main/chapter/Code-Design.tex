...
Ziel ist es ein Design aufzustellen, das mit seinen Funktionen und seiner gesamten Dokumentation für sich spricht. Des weiteren wird eine lose Kopplung der einzelnen angestrebt, damit Bestandteile ohne die Logik anderer Funktionen verstanden und bearbeitet werden können. Dies verbessert zum einen die Arbeitsaufteilung im Team zum anderen auch die Verständlichkeit des gesamten Programms. \\
...
In der nachfolgenden \tabref{tab:code.namen} sind die verwendeten Präfixe erklärt.
...
\begin{itemize}
	...
	\item Implementierung generischer Klassen beispielsweise \lstinline{calculate_error()} ermöglicht
\end{itemize}
...
\begin{itemize}
	...
	\item Refactoring wird ermöglicht
