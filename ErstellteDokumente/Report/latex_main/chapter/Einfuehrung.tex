...
Der Prototyp des ESR BB besteht aus einem Funktionsgenerator (Keysight 3600A series 2-channel ($\SI{50}{\ohm}$) AWG), einem Verstärker (AR1000A225) und der Breitband Ringkern-Kavität. Der Versuchsaufbau ist in \figref{fig:Aufbau} gezeigt. Ein Messablauf ist in \figref{fig:Messung} als Flow Chart Diagramm dargestellt.\\
