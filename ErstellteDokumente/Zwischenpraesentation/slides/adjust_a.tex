\begin{frame}[fragile]
\frametitle{Optimierung der Kennlinie}
\uncover<1->{
\begin{itemize}
  \item Anpassung der Kennlinie an das momentane Signal
\end{itemize}
}
\uncover<2->{
\begin{align*}
...
\uncover<2->{
	\item Vergleich der Samples ${\Delta U_{?,i} = \Delta U_? (i \cdot \Delta t)}$ mit ${U_{in,i} = U_{in}(i \cdot \Delta t)}$ 
\end{itemize}
...
\uncover<3->{
\begin{itemize}
	\item Anpassung der alten Parameter
\end{itemize}
\begin{align*}
