...
\title{Generierung des Eingangssingals für Barrier Bucket RF Systeme an der GSI }
...
\input{slides/Vorgehensweise}
\input{slides/TDD}
\input{slides/MockSystem}

\section{Optimierung}
\subsection{Optimierung der Übertragungsfunktion}
\input{slides/adjust_H_einf}
\input{slides/adjust_H_eval}

\subsection{Optimierung der Kennlinie}
\input{slides/adjust_a}

\section{Ausblick}
\input{slides/Ausblick}
\input{slides/EpfehlungenCodeDesign}
\input{slides/Fragen}
