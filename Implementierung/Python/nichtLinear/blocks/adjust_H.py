...
def adjust_H(Halt, Uout_ideal, Uout_measured, sigma_H):
    ...
    if not isinstance(Halt, transfer_function):
        raise TypeError('Uncorrect function call of adjust_H with Halt no instance of transfer_funtion')

    # create functions of amplitude and phaseshift as interpolations of voltage signals fft
    # frequency distance as inverse time distance, number of data points, evenly spaced frequency vector as axis of the fft
