...
[frq, H, PhaseH] = get_H.compute(80e6, 40e-3, 10, True, True, True, 1, False)                          #ÜBERPRÜFEN OB PHASE BEREINIGT

#Eingangssignal berechnen
#signal=computeUin.computeUin(f_rep, f_bb, f_g, Samplingrate)
signal=computeUin.computeUin(900e3,5e6,80e6,1e9, frq, H, PhaseH)                               #SPEICHERT JETZT SIGNAL ALS CSV
...
u_mid =  U_inp_allg.U_inp_allg( dataUout, H, PhaseH, frq )    #kann nur 900kHz             #INDIZES IN DER FOR SCHLEIFE?     
...
#Kennlinie berechnen
[ a, K ] = param.computeParam(dataUin,in_pp,u_mid,N)                                       #NORMIERUNG PRÜFEN  
