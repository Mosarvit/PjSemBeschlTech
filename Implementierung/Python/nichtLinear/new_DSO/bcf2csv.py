...
revision_string = '0.1.2, 13.05.2018'

#    STARFISH-PY, BCF2CSV: <Short description>.
...
parser = argparse.ArgumentParser(description='RF tools, BCF2CSV. Converts one or more binary column files (BCF) in text column file(s) (CSV). Only the first segment of the BCF is converted, any further segments are ignored. Revision: ' + revision_string + '.')
...
print(colorama.Back.GREEN + colorama.Style.BRIGHT + "BCF2CSV: Start." + colorama.Style.NORMAL + colorama.Back.RESET)
...
for filename in file_list:
	...
	header_description_string = 'Created by BCF2CSV'
	...
	print('BCF2CSV: file ' + output_filename + ' has been written')

print(colorama.Back.GREEN + colorama.Style.BRIGHT + "BCF2CSV: Done." + colorama.Style.NORMAL + colorama.Back.RESET)
sys.exit(0)
